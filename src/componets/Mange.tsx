const Mange = () => {
  return (
    <div className="w-full my-16 px-4 md:px-10 lg:px-24">
     
     
     
      <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-10">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-700 leading-tight">
      ...
      <div className="grid grid-cols-1  md:grid-cols-3 gap-8 ml-24 justify-center items-stretch max-w-6xl mx-auto">
        ...
        <div className="flex flex-col h-[100%]  w-[80%] items-center text-center bg-white border border-gray-100 p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-smm md:text-sm text-gray-500 leading-relaxed max-w-[250px]">
