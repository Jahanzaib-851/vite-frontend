  ...
  return (
    <div className="my-12 gap-5">
      ...
      <div className="flex items-center gap-3 flex-col  justify center">
        ...
        <strong className="sm:text-3xl"> Our Client</strong>


        <p className="text-[15px]">We have been working with some Fortune 500+ clients</p>



      </div>

      <div className=" flex flex-col  sm:flex-row items-center  justify-center   sm:w-[100%]     mt-5  mx-20 px-10    ">
